...
Dokumentasi ini menjelaskan arsitektur prapemrosesan data (*preprocessing pipeline*) untuk Modul Intelligent Triage pada proyek Lentera. Modul ini dirancang untuk dapat digunakan ulang (*reusable*) dan mendukung eksperimen berbagai arsitektur model (Machine Learning Klasik, LSTM, GRU, dan Bi-LSTM).
