        ...
        <div className="max-w-7xl mx-auto space-y-6">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                ...
                <div className="relative inline-block shrink-0">
                    ...
                    {/* Calendar Icon */}
                    <svg className="w-4 h-4 absolute left-3.5 top-3.5 text-slate-400 pointer-events-none" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                    </svg>
                    {/* Chevron Icon */}
                    <svg className="w-4 h-4 absolute right-3.5 top-3.5 text-slate-400 pointer-events-none" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                <MetricsCard 
                    title="Total Complaints" value="1,248" trend="12" isTrendPositive={true}
                ...
                />
                <MetricsCard 
                    title="Pending Review" value="342" trend="5" isTrendPositive={true}
                ...
                />
                <MetricsCard 
                    title="In Progress" value="584" trend="-2" isTrendPositive={false}
                ...
                />
                <MetricsCard 
                    title="Resolved" value="322" trend="18" isTrendPositive={true}
            ...
            {/* Bottom Row: Chart and Urgent List */}
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                
                {/* 1. Monthly Complaint Inflow Trend (2/3 width) */}
                <div className="lg:col-span-2 bg-white rounded-xl border border-slate-200 p-6 shadow-xs flex flex-col justify-between">
                    <div className="flex items-center justify-between mb-4">
                        <div>
                            ...
                            <p className="text-[11px] text-slate-400 font-semibold mt-0.5">Total incoming complaints tracked daily over the last 30 days.</p>
                        </div>
                        <button className="text-slate-400 hover:text-slate-600 p-1 rounded-md hover:bg-slate-50 transition-colors" title="Options">
                    ...
                    <div className="flex-1 w-full min-h-[250px] relative mt-2 flex flex-col justify-between">
                        <svg viewBox="0 0 500 200" className="w-full h-full text-blue-600">
                            ...
                            {/* Area Gradient Fill */}
                            <path 
                                d="M 20,180 Q 80,170 130,140 T 260,130 T 380,80 T 480,35 L 480,180 Z" 
                                fill="url(#chartGradient)" 
                                opacity="0.1" 
                            />
                            
                            {/* Projected Target Trend Line */}
                            <path 
                                d="M 20,165 C 100,150 200,140 300,120 T 480,80" 
                                fill="none" 
                                stroke="#cbd5e1" 
                                strokeWidth="2" 
                                strokeDasharray="6 6" 
                            ...
                            <path 
                                d="M 20,180 Q 80,170 130,140 T 260,130 T 380,80 T 480,35" 
                                fill="none" 
                                stroke="#0052cc" 
                                strokeWidth="3" 
                                strokeLinecap="round" 
                            ...
                            <circle cx="480" cy="35" r="5" fill="#0052cc" />
                            <circle cx="480" cy="35" r="10" fill="#0052cc" opacity="0.2" className="animate-ping" style={{ transformOrigin: '480px 35px' }} />
                ...
                {/* 2. Recent Urgent Panel (1/3 width) */}
                <div className="bg-white rounded-xl border border-slate-200 p-6 shadow-xs flex flex-col justify-between">
                    <div>
                        ...
                        <div className="space-y-4">
                            {/* Card Item 1 */}
                            <div className="p-4 rounded-lg border border-slate-100 bg-[#f8fafc]/50 hover:bg-[#f8fafc] transition-colors">
                                <div className="flex justify-between items-center text-[10px] font-bold">
                                    <span className="px-2 py-0.5 bg-red-50 text-red-600 rounded-sm uppercase tracking-wide">High</span>
                                    <span className="text-slate-400 font-semibold">10m ago</span>
                                </div>
                                <h3 className="text-xs font-bold text-slate-700 leading-snug mt-2">
                                    Data breach allegation in department Q4 financial records.
                                </h3>
                            ...
                            <div className="p-4 rounded-lg border border-slate-100 bg-[#f8fafc]/50 hover:bg-[#f8fafc] transition-colors">
                                <div className="flex justify-between items-center text-[10px] font-bold">
                                    <span className="px-2 py-0.5 bg-orange-50 text-orange-600 rounded-sm uppercase tracking-wide">Medium</span>
                                    <span className="text-slate-400 font-semibold">1h ago</span>
                                </div>
                                <h3 className="text-xs font-bold text-slate-700 leading-snug mt-2">
                                    Hostile work environment report filed against executive...
                                </h3>
                                <div className="text-[10px] text-slate-400 font-bold mt-2 flex items-center gap-1">
                                    <span>#</span>
                                    <span>CMP-9918</span>
                            ...
                            {/* Card Item 3 */}
                            <div className="p-4 rounded-lg border border-slate-100 bg-[#f8fafc]/50 hover:bg-[#f8fafc] transition-colors opacity-70">
                                <div className="flex justify-between items-center text-[10px] font-bold">
                                    <span className="px-2 py-0.5 bg-emerald-50 text-emerald-600 rounded-sm uppercase tracking-wide">Low</span>
                                    <span className="text-slate-400 font-semibold">3h ago</span>
                                </div>
                                <h3 className="text-xs font-bold text-slate-700 leading-snug mt-2 truncate">
                                    Minor system latency reported in customer dashboard access.
                                </h3>
                                <div className="text-[10px] text-slate-400 font-bold mt-2 flex items-center gap-1">
                                    <span>#</span>
                                    <span>CMP-9915</span>
